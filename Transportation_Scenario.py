...
cpu_job_id = get_ipython().getoutput('qsub queue_job.sh -d . -l nodes=1:tank-870:i5-6500te -F "CPU /data/models/intel/person-detection-retail-0013/FP32/person-detection-retail-0013 /data/resources/transportation.mp4 /data/queue_param/transportation.npy /output/results/transportation/cpu 2" -N ksrb71_command')
print(cpu_job_id[0])
...
#Submit job to the queue
gpu_job_id = get_ipython().getoutput('qsub queue_job.sh -d . -l nodes=1:tank-870:i5-6500te:intel-hd-530 -F "GPU /data/models/intel/person-detection-retail-0013/FP32/person-detection-retail-0013 /data/resources/transportation.mp4 /data/queue_param/transportation.npy /output/results/transportation/gpu 2" -N ksrb71_command')
print(gpu_job_id[0])
...
#Submit job to the queue
vpu_job_id = get_ipython().getoutput('qsub queue_job.sh -d . -l nodes=1:tank-870:i5-6500te:intel-ncs2 -F "MYRIAD /data/models/intel/person-detection-retail-0013/FP32/person-detection-retail-0013 /data/resources/transportation.mp4 /data/queue_param/transportation.npy /output/results/transportation/vpu 2" -N ksrb71_command')
print(vpu_job_id[0])
...
#Submit job to the queue
fpga_job_id = get_ipython().getoutput('qsub queue_job.sh -d . -l nodes=1:tank-870:i5-6500te:iei-mustang-f100-a10 -F "HETERO:FPGA,CPU /data/models/intel/person-detection-retail-0013/FP32/person-detection-retail-0013 /data/resources/transportation.mp4 /data/queue_param/transportation.npy /output/results/transportation/fpga 2" -N ksrb71_command')
print(fpga_job_id[0])
